    ...
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            if (!dbContext.Products.Any())
            {
                ...
                dbContext.Products.Add(new Db.Product() { Id = 3, Name = "Monitor", Price = 40, Inventory = 150 });
                dbContext.Products.Add(new Db.Product() { Id = 4, Name = "Headset", Price = 34, Inventory = 75 });
